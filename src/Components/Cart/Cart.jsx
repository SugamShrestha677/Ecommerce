...
const Cart = () => {
  return (
    <div className='flex flex-col justify-between gap-5 bg-zinc-100 fixed top-0 right-0 bottom-0 left-auto z-40 w-[400px] border-1 border-zinc-300 py-7'>
        {/* Heading */}
        <div className='px-10 '>
                ...
                <div className='flex-1'>
                    ...
                    <div  className='flex justify-between '>
                        ...
                        <div className='flex gap-2 '>
                            <button className='h-7 w-7 rounded-full bg-blue-600 text-white flex justify-center items-center text-[14px] active:bg-blue-700 cursor-pointer'><FaMinus /></button>
                            <span>1</span>
                            <button className='h-7 w-7 rounded-full bg-blue-600 text-white flex justify-center items-center text-[14px] active:bg-blue-700 cursor-pointer'><FaPlus /></button>
