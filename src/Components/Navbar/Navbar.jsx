      ...
      <nav className="max-w-[1300px] px-10 mx-auto h-[14vh] flex items-center justify-between">
        ...
        <div className="flex items-center gap-x-5">
          ...
          >
            <GoHeartFill />
            {wishlist.length > 0 && (
              <span className="bg-red-600 text-white w-5 h-5 rounded-full text-[14px] flex justify-center items-center absolute top-4 right-3 border-2 border-white">{wishlist.length}</span>
            )}
          </button>
          <button
            className="text-[1.7rem] text-zinc-800 relative cursor-pointer"
